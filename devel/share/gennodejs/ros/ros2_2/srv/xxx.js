...
class xxxRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type xxxRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type xxxRequest
    let len;
    let data = new xxxRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new xxxRequest(null);
...
class xxxResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type xxxResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type xxxResponse
    let len;
    let data = new xxxResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new xxxResponse(null);
